...
\input{math.sty}                % math-for-macro shortcuts (\bp, \E, \od, \Ac, \a, \D, ...)
\renewcommand{\memouser}{ACB}   % set default annotation username (put your initials here)
...
\begin{frame}
    \begin{eqnarray*}
        &\text{{\huge \textbf{Handwriting \& Arrows}}}\\
    \end{eqnarray*}
\end{frame}
%.......................................................
\shownotesblock{}
...
\begin{frame}[t,fragile]
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Then use standard Tikz syntax \vspace{.7cm}\par
            \hspace{-2cm}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \pause
        \item \texttt{\textbackslash lapisboxeq\{\textit{symbol}\}} can highlight objects in equations, as well as set colors and labels with option \texttt{[color=\textit{mycolor},label=\textit{mylabel}]\{\textit{text}\}}
        \begin{equation*}
            y_{t} = \a + \lapisboxeq[color=tomato,label=box1]{\b x_t} + u_{t} \vspace{-.3cm}
        \end{equation*}
        \pause
    ...
    \begin{table}[th]
        ...
        \begin{minipage}[b]{.6\textwidth}
            ...
            \begin{tabularx}{\textwidth}{lY}
                \toprule
                Dep. Variable: spread ($\D cs_{ij}$) 	& (1)\\
                \midrule
                & {Baseline Specification} \\
                \midrule
                \rowcolor{gray!10} Coeff. ($\b_1$) 		&  \lapisbox[color=tomato,label=box1]{21.15***} \\
                &   (7.35) \\
                \midrule
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item \texttt{light}: uses Fira Sans Light instead of the default Fira Sans Book
            ...
            \item \texttt{red}: switches the main color of the theme from blue to red (overridden by \texttt{night})
            \item \texttt{3to2}: switches the aspect ratio from 16:9 to 3:2
            \item \texttt{shownotes}: show notes to the slides
            \item \texttt{handout2x1}: make 2x1 handouts (portrait). Useful in combination with \texttt{shownotes}
            ...
            \item \texttt{wiggle=<n>}: set the amplitude of the pencil/sketch effect globally
            \item \texttt{hidememo}: suppress all \texttt{\textbackslash memo\{...\}} annotations
        \end{itemize}
    \end{itemize}
\end{frame}
%.......................................................
    ...
    \begin{table}[th]
        ...
        \begin{minipage}[b]{.5\textwidth}
            ...
            \begin{tabularx}{\textwidth}{lY}
                ...
                & {Baseline Specification} \\
                \midrule
                \rowcolor{gray!10} Coeff. ($\b_1$) 		&  21.15*** \\
                &   (7.35) \\
                \midrule
                \rowcolor{gray!10} Double clustering 		& Yes \\
                Time-sector FE 												& No \\
...
\begin{frame}{Sketch of demand and supply}
    \begin{center}
        \begin{tikzpicture}[scale=1.9, important line/.style={thick}, dashed line/.style={dashed, thin}, every node/.style={color=black}, dot/.style={circle,fill=black,minimum size=5.5pt,inner sep=0pt,outer sep=-1pt}]
            ...
            node(yline)[above,rotate=90,xshift=-2.5cm, yshift=1cm] {\small{\hand Credit Spread $\bp{R^B/R}$}};
            % Demand
            ...
            \node[label=\footnotesize  $\Ac_\ell$] at (0.89,1.12) (int1) {};
        \end{tikzpicture}
        \begin{tikzpicture}[scale=1.9, important line/.style={thick}, dashed line/.style={dashed, thin}, every node/.style={color=black}, dot/.style={circle,fill=black,minimum size=5.5pt,inner sep=0pt,outer sep=-1pt}]
            % Axes
            \draw[thick, ->, >=stealth', line join=miter,<->](3,0) 
            ...
            \node[label=\footnotesize  $\Ac_h$] at (1.45,0.35) (int1) {};
        \end{tikzpicture}
    \end{center}
\end{frame}
%.......................................................
...
\begin{frame}
    ...
    \end{itemize}
    \begin{center}
        \NB[.4\textwidth]{This is a small bubble}
    \end{center}
    \begin{center}
        \NB[.6\textwidth]{This is a large bubble.\\ With two lines}
    \end{center}
    \begin{center}
        \NB[.8\textwidth]{This is a larger bubble with bullets:
        \begin{itemize}
            \item Uno
            \item Dos
            \item Tres 
...
\begin{frame}[fragile]
    ...
    \begin{itemize}
        ...
        \item Code boxes can be added with the command \texttt{\textbackslash jCode\{...\}} \par
        \jCode{%
...
%=============================================================
\begin{frame}
    {Handwriting and personal notes}
    \begin{itemize}
        \item {\hand Handwriting font} is available with the \texttt{\textbackslash hand} command
        \item Bold handwriting: \handbold{bold handwritten text} with \texttt{\textbackslash handbold\{...\}}
        \begin{itemize}
            \item Stroke weight is adjustable: \handbold[0.3]{light (0.3)} \quad \handbold[0.6]{medium (0.6)} \quad \handbold[1.0]{heavy (1.0)}
            \item Pass weight as optional argument \texttt{\textbackslash handbold[\textit{weight}]\{...\}} (default: 0.6)
        \end{itemize}
        \item Comment text using \texttt{\textbackslash memo\{...\}} $\rightarrow$ \memo{This is a memo note}
        \begin{itemize}
            \item Set the default username once in the preamble: \texttt{\textbackslash renewcommand\{\textbackslash memouser\}\{ACB\}}
            \item Suppressed entirely with \texttt{hidememo} in \texttt{\textbackslash documentclass[hidememo]\{beamer\}}
            \item Per-note overrides: \texttt{\textbackslash memo[user=JB,color=cobalt]\{Check this slide.\}} $\rightarrow$ \memo[user=JB,color=cobalt]{Check this slide.}
        \end{itemize}
    \end{itemize}
\end{frame}
%.......................................................
...
\begin{frame}
    ...
    \begin{itemize}
        \item Check and cross marks with \texttt{\textbackslash cmark} and \texttt{\textbackslash xmark}: \quad \cmark\ correct \quad \xmark\ incorrect\bigskip
        \item Math shorthand \texttt{\textbackslash EE} for $\mathbb{E}$: write $\EE[x_t \mid \Fc_{t-1}]$ instead of \texttt{\$\textbackslash mathbb\{E\}\$}; \texttt{math.sty} adds the parens-aware $\E[t-1]{x_t}$\bigskip
        \item Significance stars in tables with \texttt{\textbackslash sym\{***\}}: renders as \sym{***} but marks stars as machine-readable\bigskip
        \item Font sizes for dense layouts:
        \begin{itemize}
            \item \texttt{\textbackslash tablesize} --- {\tablesize used for table content (7.25pt)}
            \item \texttt{\textbackslash miniscule} --- {\miniscule used for very small labels (4pt)}
        \end{itemize}
    \end{itemize}
\end{frame}
%.......................................................
...
%=============================================================
\begin{frame}
    {Pencil wiggle amplitude}
    \begin{itemize}
        \item The \texttt{wiggle=} option sets the amplitude of the pencil sketch effect
        \begin{itemize}
            \item Set once in \texttt{\textbackslash documentclass[wiggle=\textit{n}]\{beamer\}} (default: 0.8)
            \item Larger values $\rightarrow$ more expressive; smaller $\rightarrow$ more subtle
        \end{itemize}\bigskip
        \item The effect on underlines, boxes, and arrows:
    \end{itemize}
    \begin{center}
        \renewcommand{\jambrowiggleamp}{0.2pt}%
        \lapis{straight (0)} \quad \lapisbox{box (0)} \quad
    \end{center}
    \begin{center}
        \renewcommand{\jambrowiggleamp}{0.8pt}%
        \lapis{default (0.4)} \quad \lapisbox{box (0.4)} \quad
    \end{center}
    \begin{center}
        \renewcommand{\jambrowiggleamp}{2.5pt}%
        \lapis{expressive (2)} \quad \lapisbox{box (2)} \quad
    \end{center}
\end{frame}
%.......................................................
\shownotesblock{}
...
\begin{frame}
    ...
    \begin{itemize}
        \item Four inline arrows with \texttt{\textbackslash jarrowu}, \texttt{\textbackslash jarrowd}, \texttt{\textbackslash jarrowr}, \texttt{\textbackslash jarrowl}:
        \begin{itemize}
            \item GDP growth \jarrowu\ rose; unemployment \jarrowd\ fell; exports \jarrowr\ shifted right
        \end{itemize}\bigskip
        \item Options \texttt{[color=, len=, lw=, pad=]}:
        \begin{itemize}
            \item Default: \jarrowu\ \jarrowd\ \jarrowr\ \jarrowl
            \item Custom color: \jarrowu[color=tomato]\ \jarrowd[color=cobalt]\ \jarrowr[color=mint]
            \item Longer / heavier: \jarrowr[len=1.2cm]\ \jarrowr[len=0.6cm,lw=0.12cm]
        \end{itemize}\bigskip
        \item Full names also work: \texttt{\textbackslash jarrowup}, \texttt{\textbackslash jarrowdown}, \texttt{\textbackslash jarrowright}, \texttt{\textbackslash jarrowleft}
    \end{itemize}
\end{frame}
%.......................................................
\shownotesblock{}
